	                    ...
	                    <div class="panel panel-default">
		                    <div class="panel-heading" role="tab" id="headingTwo">
			                    <h4 class="panel-title">
				                    <a href="../article?type=2"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>殡葬传统</a>
			                    </h4>
		                    </div>
                        </div>
	                    <div class="panel panel-default">
		                    <div class="panel-heading" role="tab" id="headingTwo">
			                    <h4 class="panel-title">
				                    <a href="../article?type=3"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>文化常识</a>
			                    </h4>
		                    </div>
	                    </div>
                    </div>
