	                    ...
	                    <div class="panel panel-default">
		                    <div class="panel-heading" role="tab" id="headingTwo">
			                    <h4 class="panel-title">
				                    <a href=""><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>从去世到安葬的整个过程</a>
			                    </h4>
		                    </div>
	                    </div>
	                    <div class="panel panel-default">
		                    <div class="panel-heading" role="tab" id="headingTwo">
			                    <h4 class="panel-title">
				                    <a href=""><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>基本丧葬费</a>
			                    </h4>
		                    </div>
                        </div>
	                    <div class="panel panel-default">
		                    <div class="panel-heading" role="tab" id="headingTwo">
			                    <h4 class="panel-title">
				                    <a href=""><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>选择性消费</a>
			                    </h4>
		                    </div>
	                    </div>
	                    <div class="panel panel-default">
		                    <div class="panel-heading" role="tab" id="headingTwo">
			                    <h4 class="panel-title">
				                    <a href=""><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>指定服务点</a>
			                    </h4>
		                    </div>
	                    </div>
                    </div>
