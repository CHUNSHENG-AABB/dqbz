...
Source Database       : dqbz

Target Server Type    : MYSQL
Target Server Version : 50718
File Encoding         : 65001

Date: 2017-08-06 15:42:59
*/
...
CREATE TABLE `activity` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='活动';
...
CREATE TABLE `article` (
  ...
  `UPDATE_USER` varchar(50) DEFAULT '' COMMENT '更新人',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='文章';
...
CREATE TABLE `member` (
  ...
  `UPDATE_USER` varchar(50) DEFAULT '' COMMENT '更新人',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='会员单位';
...
CREATE TABLE `news` (
  ...
  `UPDATE_USER` varchar(50) DEFAULT '' COMMENT '更新人',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='新闻';
...
CREATE TABLE `product` (
  ...
  `UPDATE_USER` varchar(50) DEFAULT '' COMMENT '更新人',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='产品服务';
